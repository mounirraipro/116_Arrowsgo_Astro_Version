...
export const externalGames = [
  {
    ...
    seoOverview:
      "Brain Line Connect is a useful companion for Remove All Arrows players because both games reward planning before movement. Instead of launching arrows in sequence, you map a continuous line through each required point while avoiding blocked paths. It is slower, but it trains the same habit of reading the board before committing.",
    howToPlay:
  ...
  },
  {
    ...
    shortTitle: "Bubbles",
    description: "Aim, bank shots, and clear color clusters in a quick browser puzzle.",
    seoOverview:
      "Bubble Shooter fits beside Remove All Arrows because it adds aiming and path prediction to the same quick-session rhythm. Every shot asks players to read space, predict a path, and avoid filling the board with bad decisions.",
    howToPlay:
  ...
  },
  {
    ...
    seoOverview:
      "Block Puzzle is a good option when Arrows Go players want a slower puzzle challenge. The pressure comes from space management rather than speed, but the core idea is familiar: one careless move can close a useful path.",
    howToPlay:
  ...
  },
  {
    ...
    seoOverview:
      "2048 Merge Blocks is a number game with a strong planning loop. It complements Remove All Arrows by trading launch-order logic for board discipline: matching values need to stay close enough to combine before the space disappears.",
    howToPlay:
  ...
  },
  {
    ...
    seoOverview:
      "Sudoku Block Puzzle gives Arrows Go visitors a more deliberate grid challenge. The game rewards clean placement, space control, and decisions that set up future clears instead of quick guesses.",
    howToPlay:
  ...
  },
  {
    ...
    seoOverview:
      "Word Search is a quieter related game for players who use Arrows Go as a short focus break. It keeps the instant browser format while changing the challenge from launch-order logic to visual scanning.",
    howToPlay:
