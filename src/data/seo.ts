...
const routeFallbackSeo = (route: SiteRoute): SeoPage => ({
  ...
  description:
    route.path === "/"
      ...
      : `${route.title} for ${siteConfig.name}, a free ${siteConfig.gameGenre} you can play in a modern browser.`,
  schemaType: "WebPage",
});
...
const pageOverrides: Partial<Record<string, Partial<SeoPage>>> = {
  "/": {
    ...
    seoTitle: "Arrows Go Online - Free Arrow Arcade Game",
    description: siteConfig.description,
    priority: 1,
    changeFrequency: "weekly",
  },
  "/play": {
    seoTitle: "Play Arrows Go Online - Free Browser Game",
    description: "Play Arrows Go free in your browser. Change direction, avoid hazards, and restart instantly with no download or account.",
    priority: 0.9,
    changeFrequency: "weekly",
  },
  "/games": {
    seoTitle: "Free Browser Games Like Arrows Go",
    description: "Play Arrows Go and related browser games focused on timing, aiming, pathing, grid planning, and quick no-download sessions.",
    priority: 0.82,
    changeFrequency: "weekly",
  },
  "/how-to-play": {
  ...
  return [
    {
      ...
      alternateName: ["Arrows Go Online", "ArrowsGo", "Arrow arcade game"],
